...
import { cartItemArray, componentLoader } from '@/context/Global-Context';
import Image from 'next/image';

type CartDetProps = {
  cartItems: cartItemArray;
  handleDeleteCartItem: (e: string) => void;
                      ...
                      >
                        <div className='shrink-0'>
                          <Image
                            ...
                            alt='Product image'
                            className='h-35 w-25 max-w-full max-h-40 rounded-lg object-fill'
                          />
                        </div>
